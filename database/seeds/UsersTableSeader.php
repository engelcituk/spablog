...
class UsersTableSeader extends Seeder
{
    ...
    public function run()
    {
        ...
        $deletePostsPermission = Permission::create(['name'=>'Delete posts','display_name'=>'Borrar posts']);
        ...
        $admin = new User;
        $admin->name="Jose Luis";
        $admin->email="luis@gmail.com";
        ...
        $writer = new User;
        $writer->name="Luis pedro";
        $writer->email="luispedro@gmail.com";
